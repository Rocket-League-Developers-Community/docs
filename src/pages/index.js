...
export default function Home() {
  ...
  return (
    <Layout
      title={`Rocket League Japan Developers Community`}
      description="Rocket League Japan Developers Community"
    >
      ...
      <main>
        {features && features.length > 0 && (
          <section className={clsx('home--features', styles.features)}>
            <div className="container">
              <div className="row">
